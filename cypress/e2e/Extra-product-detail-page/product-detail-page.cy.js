...
describe("Extra Product Detail Page", function () {
  ...
  it("Case 1: Product detail page", function () {
    cy.visit(
      "https://staging.extra.ge/product/apple-13-macbook-pro-a2338-m1-512gb-2020-space-gray-noutbuqi/260681"
    );
  ...
  it("Case 3: Product detail page with color and size", function () {
    cy.visit(
      "https://staging.extra.ge/product/muqi-lurji-maghal-saqeloiani-sada-trikotazhis-maisuri/405089"
    );
    cy.wait(3000);
    cy.get(selector.elements.closeCookie()).click();
